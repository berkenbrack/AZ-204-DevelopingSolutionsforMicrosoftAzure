...
<!--ID/SME: Per our formatting guidelines, panes are always bold, including "navigation."-->
...
#### Review
<!--ID/SME: Per MS style guide: On first reference, Azure Web App should be referred to as Web Apps feature of Microsoft Azure App Service. Subsequent mentions "Web Apps", but not "Azure Web Apps".-->
...
#### Review
<!--ID/SME: This is the first instance where Content Delivery Network isn't used in a heading, so I added the acronym as it's used later in the document.-->
...
#### Review
<!--ID/SME: Are you referring to the feature "Web App" or user-created "web app"?-->
...
<!--ID/SME: URI isn't spelled out or used anywhere else except as UI term. It should be spelled out as "Uniform Resource Identifier" on first use.-->
...
#### Review
<!--ID/SME: Are you referring to the feature "Web App" or user-created/generic "web app"?-->
